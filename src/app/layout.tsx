...
import BuildingsCombobox from "@/app/buildings-combobox";
...
export default async function RootLayout(props: RootLayoutProps) {
    ...
    return (
        ...
        <div className='h-16 px-4 flex items-center bg-yellow-400 gap-6'>
            ...
            <BuildingsCombobox buildings={buildings}/>
